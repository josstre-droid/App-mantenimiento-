...
import { LogOut, FileText, Camera, DollarSign, Receipt, Scale, Wrench, Loader2, AlertCircle } from "lucide-react";
...
export default function App() {
  ...
  const modulosCliente = [
    ...
    cliente?.ve_equipos && { icon: Wrench, label: "Mis equipos" },
    ...
    <div style={styles.page}>
      ...
      {vista === "reportes" ? (
        ...
        <div style={{ maxWidth: 760, margin: "28px auto", padding: "0 20px" }}>
          ...
          >
            {modulos.map((m, i) => {
              const activo = m.label === "Reportes fotográficos" || m.label === "Cotizaciones" || m.label === "Mis cotizaciones" || m.label === "Gastos e ingresos" || m.label === "Cobranza" || m.label === "Estado de cuenta" || m.label === "Balance" || m.label === "Equipos" || m.label === "Mis equipos";
              const destino = m.label.includes("otizaciones") ? "cotizaciones"
                ...
                : (m.label === "Equipos" || m.label === "Mis equipos") ? "equipos"
                : "reportes";
              return (
                <div
                  key={i}
