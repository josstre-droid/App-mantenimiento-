    ...
    <div style={styles.page}>
      ...
      {vista === "reportes" ? (
        ...
        <div style={{ maxWidth: 760, margin: "28px auto", padding: "0 20px" }}>
          ...
          >
            {modulos.map((m, i) => {
              const activo = m.label === "Reportes fotográficos" || m.label === "Cotizaciones" || m.label === "Mis cotizaciones";
              const destino = m.label.includes("otizaciones") ? "cotizaciones" : "reportes";
              return (
                <div
                  key={i}
