...
import { LogOut, FileText, Camera, DollarSign, Receipt, Loader2, AlertCircle } from "lucide-react";
...
export default function App() {
  ...
  const [vista, setVista] = useState("dashboard"); // dashboard | reportes | cotizaciones
    ...
    <div style={styles.page}>
      ...
      {vista === "reportes" ? (
        ...
        <div style={{ maxWidth: 760, margin: "28px auto", padding: "0 20px" }}>
          ...
          >
            {modulos.map((m, i) => {
              const activo = m.label === "Reportes fotográficos" || m.label === "Cotizaciones" || m.label === "Mis cotizaciones" || m.label === "Gastos e ingresos" || m.label === "Cobranza" || m.label === "Estado de cuenta";
              const destino = m.label.includes("otizaciones") ? "cotizaciones" : m.label === "Gastos e ingresos" ? "gastos" : (m.label === "Cobranza" || m.label === "Estado de cuenta") ? "cobranza" : "reportes";
              return (
                <div
                  key={i}
