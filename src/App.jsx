    ...
    <div style={styles.page}>
      ...
      {vista === "reportes" ? (
        ...
        <div style={{ maxWidth: 760, margin: "28px auto", padding: "0 20px" }}>
          ...
          >
            {modulos.map((m, i) => {
              const activo = m.label === "Reportes fotográficos" || m.label === "Cotizaciones" || m.label === "Mis cotizaciones" || m.label === "Gastos e ingresos";
              const destino = m.label.includes("otizaciones") ? "cotizaciones" : m.label === "Gastos e ingresos" ? "gastos" : "reportes";
              return (
                <div
                  key={i}
